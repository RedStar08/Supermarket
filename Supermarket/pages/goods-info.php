      ...
      <table class="layui-table" lay-filter="demo" lay-even lay-skin="nob">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php $str .= "&6=".$row['supplierName'];echo htmlspecialchars($row['supplierName']);?></td>
            <td><?php $str .= "&7=".$row['produceID'];echo htmlspecialchars($row['produceID']);?></td>
            <td><?php $str .= "&8=".$row['produceDate'];echo htmlspecialchars($row['produceDate']);?></td>
            <td><?php $str .= "&9=".$row['produceArea'];echo htmlspecialchars($row['produceArea']);?></td>
            <td><?php $str .= "&10=".$row['note'];echo htmlspecialchars($row['note']);?></td>
            <!-- 商品操作 -->
            <td class="td-status">
              <span class="layui-btn layui-btn-normal layui-btn-sm">正售卖</span>
            </td>
          </tr> 
          <?php }?>
        </tbody>
